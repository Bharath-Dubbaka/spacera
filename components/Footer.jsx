...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-bronze-deep/40 bg-[#C39F73] px-6 py-16 sm:px-12 text-neutral-900/80">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 sm:flex-row sm:justify-between">
        <div className="max-w-sm">
          ...
          <p className="mt-4 text-sm leading-relaxed text-stone">
            Every next piece begins with A space and time fabric that folds back
            on itself.
          </p>
        </div>
