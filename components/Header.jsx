  ...
  return (
    ...
    >
      ...
      <div className="relative flex justify-center items-center text-[12px] font-normal text-gray-850 tracking-wider h-6 uppercase">
        <Link
          href="/"
          className="absolute left-0 no-underline text-xl font-extralight text-[#3A3A3A]"
        >
          GL{" "}
        </Link>
            ...
            <div className="flex flex-col min-[1000px]:flex-row gap-8 justify-between pt-12 pb-6 px-6 items-start">
              <div className="flex flex-col justify-between flex-1 w-full min-h-[250px]">
                ...
                <div className="grid grid-cols-2 min-[1000px]:flex min-[1000px]:justify-between items-end gap-4 text-[10px] uppercase text-[#BC4424] tracking-wider pt-12 border-t border-neutral-900/40">
                  <div>
                    <span className="text-[#BC4424] mr-1">Made by:</span>spacera
                  </div>
                  <div>
                    <span className="text-[#BC4424] mr-1">Typography:</span>
                    Google Fonts
                  </div>
                  <div>
                    <span className="text-[#BC4424] mr-1">Privacy</span>Policy
                  </div>
                  <div
